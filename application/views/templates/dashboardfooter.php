...
<script>
  ...
  function loadData() {
    $.ajax({
      url: "<?=base_url('index.php/dataManagement/dataSUMSUK');?>",
      data:{
        bulan:bulan
      },
      method:'post',
  ...
  function loadPiutang() {
    $.ajax({
      url: "<?=base_url('index.php/dataManagement/dataPiutangAnggota');?>",
      data:{},
      method:'post',
      dataType:'json',
      success:function (data) {
  ...
  function loadSibulan() {
    $.ajax({
      url: "<?=base_url('index.php/dataManagement/dataSibulan');?>",
      data:{},
      method:'post',
      dataType:'json',
      success:function (data) {
