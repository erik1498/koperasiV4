<div class="row">
    <div class="col-lg-2">
        <div class="card shadow">
            <div class="card-body">
                <form action="<?=base_url('index.php/cetak/sumlalu')?>" method="post">
                <div class="row">
                        <div class="col-lg-7">
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label for="">&nbsp;</label>
                                <button type="submit" class="btn btn-danger btn-sm form-control form-control-sm"><i class="fa fa-sticky-note mr-2"></i><b>Lihat PDF</b></button>
                            </div>
                        </div>
                    </form>
